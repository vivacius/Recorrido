...
@st.cache_data
def cargar_datos():
    df = pd.read_csv("C:/Users/sacor/Downloads/integracion.txt", delimiter=';')
...
st.subheader("Resumen de Inicio de Labores por Zona")
...
#python -m streamlit run c:/Users/sacor/Downloads/er.py